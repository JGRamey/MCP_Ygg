...
from agents.analytics.graph_analysis.trend_analysis.statistics_engine import StatisticsEngine
from agents.analytics.graph_analysis.trend_analysis.seasonality_detector import SeasonalityDetector
from agents.analytics.graph_analysis.trend_analysis.trend_visualization import TrendVisualizer
...
class TestTrendDetector(TestTrendAnalysisBase):
    ...
    @pytest.mark.asyncio
    async def test_trend_detection_analysis(self, analysis_config, sample_time_series, mock_session):
...
class TestTrendPredictor(TestTrendAnalysisBase):
    ...
    @pytest.mark.asyncio
    async def test_trend_prediction_analysis(self, analysis_config, sample_time_series, mock_session):
    ...
    @pytest.mark.unit
    def test_exponential_smoothing_prediction(self, analysis_config, sample_time_series):
...
class TestStatisticsEngine(TestTrendAnalysisBase):
    ...
    @pytest.mark.asyncio
    async def test_statistical_analysis(self, analysis_config, sample_time_series, mock_session):
...
class TestSeasonalityDetector(TestTrendAnalysisBase):
    ...
    @pytest.mark.asyncio
    async def test_seasonality_detection_analysis(self, analysis_config, sample_time_series, mock_session):
...
class TestTrendVisualizer(TestTrendAnalysisBase):
    ...
    @pytest.mark.asyncio
    async def test_trend_visualization_analysis(self, analysis_config, sample_time_series, mock_session):
...
class TestTrendAnalyzerCore(TestTrendAnalysisBase):
    ...
    @pytest.mark.asyncio
    async def test_comprehensive_trend_analysis(self, analysis_config, sample_time_series, mock_session):
    ...
    async def test_trend_analysis_with_seasonal_data(self, analysis_config, mock_session):
