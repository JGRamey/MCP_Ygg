...
class ProjectLinter:
    ...
    def _find_python_files(self) -> List[Path]:
        ...
        search_dirs = ["agents", "api", "dashboard", "scripts", "tests"]
    ...
    def _run_tool(self, tool_name: str, tool_config: Dict) -> LintResult:
        ...
        try:
            ...
            print(f"   {status} - {error_count} errors, {warning_count} warnings ({execution_time:.2f}s)")
    ...
    def _parse_tool_output(self, tool_name: str, stdout: str, stderr: str) -> Tuple[int, int]:
        ...
        if tool_name == "flake8":
            ...
            # Count ruff issues
            lines = stdout.strip().split('\n') if stdout.strip() else []
            error_count = len([line for line in lines if line.strip() and not line.startswith("Found")])
    ...
    def run_all_tools(self, parallel: bool = True, tools: Optional[List[str]] = None) -> List[LintResult]:
        """Run all linting tools"""
        print("🚀 Starting comprehensive code quality analysis for MCP Yggdrasil Project")
    ...
    def generate_report(self, output_file: Optional[str] = None) -> str:
        ...
        if total_errors == 0 and total_warnings == 0:
            ...
            if total_errors > 50:
                report_lines.append("4. Consider running 'black' and 'isort' to auto-fix formatting")
