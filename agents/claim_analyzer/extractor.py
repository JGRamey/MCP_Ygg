...
from .utils import sanitize_text, validate_input, clean_claim_text
...
class ClaimExtractor:
    ...
    async def extract_claims(self, text: str, source: str = "unknown", domain: str = "general") -> List[Claim]:
        ...
        try:
            ...
            claims = await self._extract_with_spacy(text, source, domain) if self.nlp else \
                     await self._extract_with_patterns(text, source, domain)
