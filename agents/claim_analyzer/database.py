...
class DatabaseConnector:
    ...
    async def _initialize_qdrant_collections(self):
        ...
        collections = [
            ...
            {"name": "evidence", "vector_size": 384, "distance": Distance.COSINE},
        ]
            ...
            try:
                self.qdrant_client.create_collection(
                    ...
                    vectors_config=VectorParams(
                        size=collection["vector_size"], distance=collection["distance"]
                    ),
                )
                ...
                if "already exists" in str(e).lower():
                    logger.info(
                        f"Qdrant collection already exists: {collection['name']}"
                    )
                else:
