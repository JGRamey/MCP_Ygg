...
class TranscriptProcessor:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.preserve_timestamps = config.get('processing', {}).get('preserve_timestamps', True)
        
        logger.info("Transcript processor initialized")
    
    async def process_transcript(self, raw_transcript: List[Dict[str, Any]], video_id: str) -> ProcessedTranscript:
        """
    ...
    def _process_segments(self, raw_transcript: List[Dict[str, Any]], is_auto_generated: bool) -> List[TranscriptSegment]:
        """
    ...
    def _is_auto_generated(self, raw_transcript: List[Dict[str, Any]]) -> bool:
        ...
        indicator_count = sum(1 for pattern in auto_indicators if re.search(pattern, sample_text))
        
        return indicator_count >= 2
    
    def _create_chapters(self, segments: List[TranscriptSegment], duration: int) -> List[Dict[str, Any]]:
        """
    ...
    def _calculate_sentiment(self, text: str) -> Optional[float]:
        ...
        try:
            ...
            negative_words = {'bad', 'terrible', 'awful', 'horrible', 'hate', 
                            'disgusting', 'worst', 'stupid', 'annoying', 'boring'}
    ...
    def format_transcript_for_display(self, transcript: ProcessedTranscript, 
