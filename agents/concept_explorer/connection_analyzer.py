...
class ConnectionAnalyzer:
    ...
    async def analyze_connections(self, concepts: List[Dict[str, Any]]) -> List[ConnectionStrength]:
    ...
    def _calculate_connection_strength(self, concept1: Dict[str, Any], concept2: Dict[str, Any]) -> float:
