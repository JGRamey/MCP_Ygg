...
class ClaimAnalyzerAgent:
    ...
    def __init__(self, config_path: str = "agents/analytics/claim_analyzer/config.yaml"):
        ...
        try:
            ...
            if config_file.exists():
                if config_path.endswith('.yaml') or config_path.endswith('.yml'):
                    ...
                    logger.warning(f"Config file {config_path} format not supported, using defaults")
