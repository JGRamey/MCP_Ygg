...
def create_navigation_sidebar(current_page: str, pages: List[Dict[str, str]], 
    ...
    with st.sidebar:
        ...
        if show_metrics:
            ...
            metrics = st.session_state.get('quick_metrics', {
                'concepts': 'N/A',
                'relationships': 'N/A',
                'last_update': 'N/A'
            })
...
def create_filter_sidebar(filters: Dict[str, Any], 
                         title: str = "🗃️ Filters") -> Dict[str, Any]:
    """
...
def create_operations_sidebar() -> Dict[str, Any]:
    ...
    with st.sidebar:
        ...
        with col1:
            operations['restart_agents'] = st.button("🔄 Restart", key="ops_restart_agents")
...
def create_analytics_sidebar() -> Dict[str, Any]:
    ...
    with st.sidebar:
        ...
        analytics_params['metrics'] = st.multiselect(
            "Metrics to Display",
            [
                "Concept Count", "Relationship Count", "Query Performance",
                "Cache Hit Rate", "Error Rate", "User Activity"
            ],
        ...
        # Generate report
        analytics_params['generate_report'] = st.button("📊 Generate Report", type="primary")
