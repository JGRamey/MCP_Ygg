...
from components.config_management import get_dashboard_state, DashboardConfig
    ...
    try:
        ...
        if page_function:
            try:
                ...
                st.error(f"Error loading {selected_page} page. Please try refreshing or contact support.")
        else:
