...
class SearchOperations:
    ...
    def execute_graph_query(
        self, query: str, query_type: str = "Cypher", max_nodes: int = 100
    ) -> Dict[str, Any]:
...
def perform_semantic_search(
    ...
    search_ops = SearchOperations()
    return search_ops.perform_semantic_search(
        query, threshold, include_concepts, cross_domain, max_results
    )
